...
def main():
    ...
    windows = []
    labels = []
    #We take as training set images from 0 to 499
    ...
    weight_save_file = 'weights.hdf5'
    cp = keras.callbacks.ModelCheckpoint(weight_save_file, monitor='acc', save_best_only=True, save_weights_only=True)
